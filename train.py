...
from model.models import HyFi, HGNN
...
def train(data, model, optimizer, params, epoch):
    ...
    for i in range(params['num_views']):
        n3, e3 = model(features, hyperedge_index, dropout_rate, noise_std_n)
...
def main():
    ...
    for seed in range(args.num_seeds):
        ...
        model = HyFi(encoder, params['proj_dim'], args.device).to(args.device)
